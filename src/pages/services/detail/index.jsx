    ...
    <>
      <section className="bannerServicesDetail">
        <div className="container">
          <div className="row">
            <div className="card glassBg col-6 col-md-3">
      ...
      <section className="container my-120">
        <div className="row">
          <div className="col-12 col-lg-7 px-0 row">
            <img src="https://live.staticflickr.com/65535/54301904962_b0a76caef3.jpg" alt="before" className="col-6 img-fluid" />
            <img src="https://live.staticflickr.com/65535/54301904972_eda8cf4ccd.jpg" alt="after"  className="col-6 img-fluid" />
          </div>
